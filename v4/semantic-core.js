...
//   ⑤ v4.10.1：neg0 补 n7 平台禁讲敏感话题 / n8 侮辱直播用户
//      （《抖音直播客观违规规则》Sheet1 第6、8 类，表中原无字面词 ⇒ 只能语义判定，
//        字面通道见 v4/violation-rules.js + v4/violation-scan.js）
//      ⚠️ 命中 n1–n8 任一，按业务侧 2026-09-17 口径均属"整场总分归 0"级，由壳层 v4.11.16 执行
...
(function(root, factory){
  ...
  var NEG_POINTS = [
    ...
    // ---- v4.10.1 补齐《抖音直播客观违规规则》Sheet1 中"表中无字面词"的两类 ----
    // 这两类原文本就没有关键词（见 violation-rules.js 注释）⇒ 只能语义判定，故补进本卡。
    // ⚠️ 命中 n1–n8 任一，按业务侧 2026-09-17 口径均属「整场总分归 0」级（由壳层 v4.11.16 执行）。
    { id: 'n7', name: '平台禁讲敏感话题', q: '是否讲解了平台明令禁止讨论的敏感话题（涉及国家/地区、特殊日期节点、公众人物、社会争议事件的评论性言论）？仅判断"是否出现该类别内容"，不评价内容本身。' },
    { id: 'n8', name: '侮辱直播用户',   q: '是否侮辱、嘲讽、贬低直播间用户，或威胁对其禁言/拉黑（如"买不起就别问""拉黑你了""穷就别看"）？' }
  ];
