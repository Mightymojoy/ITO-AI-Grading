 ...
 *      短词根条目须在命中点**紧邻** L/R 字内出现其完整短语/语境
 *      依据：59 份真实直播逐字稿（8.13-9.15 / 105.7 万字）实测，222 条里 201 条零触发，
 *            真正惹事的只有 2-3 字「会独立成词」的短条目 ⇒ 只有它们需要语境约束。
 *      口径：① 业务侧 2026-09-17 二次拍板「"行业第一"必须 4 字都说了才判违规；
 *               只说"第一"、或只说"行业"，均不归纳到违规中」
 *            ② 三次拍板「诱导互动类也加语境必配」—— 违规点是"以利益**诱导**"，不是字样本身
 *
 * ⚠️ 落地前必做「全语料实测」：初版口径下 53 份真实场次有 30 份（56.6%）整场归 0，
 *    等于把整场评分统一压成 0。改任何 GUARD/EXEMPT 后都应重跑 assets 里的 allscan 脚本。
 *
